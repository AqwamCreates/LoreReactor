...
export interface Location extends ObjectData { // Characters can go to a location if regex is met. regularExpressionActivationTrigger is added just in case a place can enter by unconventional means like flying or teleportation.
...
export interface Memory extends ObjectData {
  ...
  interactionData: InteractionData;    // Traceability
}

export interface RawMemory extends RawData {
  content: string; // For importance-based pruning
  interactionDataId: string;    // Traceability
}
