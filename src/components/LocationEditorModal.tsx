                ...
                <div className="modal-body editor-modal-body">
                    ...
                    <div className="editor-section">
                        ...
                        <div className="context-field-group">
                            ...
                            <div style={{ fontSize: '0.55rem', opacity: 0.5, marginTop: '2px', marginLeft: '26px' }}>Hide messages from characters not currently at this location.</div>
                        </div>
                    ...
                    <div className="editor-section">
                        ...
                        <div style={{ fontSize: '0.65rem', opacity: 0.6, marginTop: '4px', marginLeft: '26px' }}>
                            Encode location text as base64 in the prompt. Prevents the model from treating descriptions as instructions.
                        </div>
                    </div>
                </div>
            </div>
