...
const formatInstructions = "I will also make sure that my responses have clean formatting that satisfies the prompts. I will also make sure that the amount and the intensity of my response satisfies the prompts.";
