...
export function MultiplayerSettingsModal({
    ...
    const { save, loadForChat, isLoading } = useMultiplayerDataManager();
    ...
    const handleSave = useCallback(async () => {
        ...
        try {
            ...
            // Ensure current chat is in interactionDataIds
            ...
            <div className="modal-content editor-modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: '700px' }}>
                <div className="modal-header">
                    ...
                    <div className="editor-modal-actions">
                        <button type="button" className="editor-button editor-button-save" onClick={handleSave} disabled={isSaving || isLoading} style={{ fontSize: '0.75rem' }}>
                ...
                {isLoading && (
                    <div style={{ textAlign: 'center', padding: '30px', opacity: 0.5, fontSize: '0.8rem' }}>Loading multiplayer data...</div>
                )}
