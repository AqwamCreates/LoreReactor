...
const TOOL_DESCRIPTIONS: Record<tool, string> = {
    ...
    lock: 'Allow this character to lock a location, preventing entry via its binding triggers until unlocked.',
    unlock: 'Allow this character to unlock a previously locked location, restoring access via its binding triggers.',
