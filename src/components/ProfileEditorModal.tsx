...
function ProfileEditorContent({
    ...
    const [randomizeTextCharacterInjection, setRandomizeTextCharacterInjection] = useState<boolean>((ep as unknown as Record<string, unknown>)?.randomizeTextCharacterInjection as boolean ?? false);
