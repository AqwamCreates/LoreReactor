...
const TOOL_INSTRUCTION_MAP: Record<tool, string> = {
    ...
    clothing: `${generalStartString}To change what a character is wearing, I write ${toolStartSring}clothing <character_id> wear <clothing_id>${toolEndString} to wear an item, or ${toolStartSring}clothing <character_id> remove <clothing_id>${toolEndString} to remove it. The clothing item must exist in the character's wardrobe. Tool calls are replaced with confirmation of the clothing change.${generalEndString}`,
