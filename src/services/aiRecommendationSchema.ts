...
export function buildJsonSchema(selectedEntities: EntityType[]): string {
    ...
    "tools": {
      ...
      "calculator": "boolean (default false)", "web": "boolean (default false)", "dialogue": "boolean (default false)", "lookup": "boolean (default false)",
    ...
    "tools": {
      ...
      "calculator": "number (-1, 0, or 1, default 0)", "web": "number (-1, 0, or 1, default 0)", "dialogue": "number (-1, 0, or 1, default 0)", "lookup": "number (-1, 0, or 1, default 0)",
