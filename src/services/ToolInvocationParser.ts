...
const characterAgnosticTools = ['pick', 'date', 'coin', 'dice', 'random', 'rng', 'move', 'dialogue', 'lookup', 'map', 'audio', 'clothing', 'note', 'inventory'] // Audio is here because you can make noises from footsteps and stuff like that.
